...
def to_user_message(posts, topic: str, problems):
    p_lines = []
...
def to_assistant_message(posts, frames, problems):
    m_problems = {}
    m_frames = {}
    m_lookup = {}
    for p_idx, post in enumerate(posts, start=1):
        ...
        for f_id, f_label in post["labels"].items():
            ...
            if f_id not in m_lookup:
                ...
                m_frames[m_f_id] = {
                    ...
                    "frame": preprocess_tweet(frames[f_id]["text"], preprocess_config),
                }
                ...
                "properties": {
                    "frames": {
                        ...
                        "items": {
                            ...
                            "properties": {
                                "posts": {
                                    "description": "The post IDs (T1, T2, etc.) where this frame of communication is evoked.",
                                    "type": "array",
                                    "items": {
                                        "type": "string",
                                    },
